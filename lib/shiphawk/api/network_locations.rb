  ...
  module Api
    ...
    class NetworkLocations < Resource
      ...
      def self.create_network(params={})
        response, api_key = ShipHawk::Client.request(:post, '/network_locations/create_network_location', @api_key, params)
      ...
      def self.assign(params={})
        response, api_key = ShipHawk::Client.request(:post, '/network_locations/assign_allowed_affiliate', @api_key, params)
        ShipHawk::Helpers::Util::convert_to_ShipHawk_object(response, api_key) if response
      end
      ...
      def self.unassign(params={})
        response, api_key = ShipHawk::Client.request(:post, '/network_locations/remove_allowed_affiliate', @api_key, params)
        ShipHawk::Helpers::Util::convert_to_ShipHawk_object(response, api_key) if response
      end

      # return list of allowed network locations for origin
      def self.allowed
        response, api_key = ShipHawk::Client.request(:get, '/network_locations/allowed_affiliates', @api_key, params)
        ShipHawk::Helpers::Util::convert_to_ShipHawk_object(response, api_key) if response
      end
      ...
      def self.closest_to_zip(params={})
        response, api_key = ShipHawk::Client.request(:get, '/network_locations/network_locations_for_zip', @api_key, params)
        ShipHawk::Helpers::Util::convert_to_ShipHawk_object(response, api_key) if response
      end
      ...
      def self.assign_to_shipment(params={})
        response, api_key = ShipHawk::Client.request(:post, '/network_locations/assign_origin_network_location_to_shipment_format', @api_key, params)
        ShipHawk::Helpers::Util::convert_to_ShipHawk_object(response, api_key) if response
      end
